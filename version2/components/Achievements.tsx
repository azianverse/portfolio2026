...
export const achievements: Achievement[] = [
  // ── External Competitions ──────────────────────────────────────────────
  {
    ...
    accent: "#f59e0b",
    icon: "trophy",
    organizer: "Regional Tech Council",
  ...
  {
    id: 4,
    slug: "codechella-lead",
    category: "school",
    title: "CodeChella Visual Lead",
    event: "CodeChella — Tech Festival Booth Event",
    place: "Lead Designer",
    placeRank: 0,
    date: "2023",
    shortDesc: "Led the full visual identity for CodeChella — one of the org's biggest annual events.",
    desc: "CodeChella was the project I'm proudest of from my school years. I conceptualized and executed the entire visual identity — a surreal cosmic-desert aesthetic with liquid-chrome typography, disco ball motifs, and festival-grade energy. Every touchpoint was mine: digital pubmats, physical banners, merchandise graphics, and the on-site booth design. Seeing hundreds of students interact with something I built from a blank canvas was an unforgettable feeling.",
    thumbnail: null,
    gallery: [null, null, null, null],
    accent: "#00f5d4",
    icon: "star",
    organizer: "JCPSC — Universidad de Dagupan",
  },
  {
    id: 5,
    slug: "dean-lister",
